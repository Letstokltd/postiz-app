...
export const metadata: Metadata = {
  title: 'Privacy Policy - LetsPost',
  description: 'Privacy Policy for LetsPost social media scheduling platform',
};
    ...
    <div className="min-h-screen bg-[var(--new-bgColor)] text-[var(--new-btn-text)] p-6 md:p-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-sm">
          ...
          <p>
            Welcome to LetsPost (social.letstok.com). We value your privacy and
